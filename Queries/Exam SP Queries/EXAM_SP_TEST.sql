...
SELECT * FROM Course
EXECUTE GenerateExam 'OOP',3,5,5
---------------------------------------------------------------------------------
---------------------------------------------------------------------------------
---------------------------------------------------------------------------------
...
--TEST
-- GENERATE EXAM FIRST 
EXEC GenerateExam @EXTITLE = 'DATABASE'  , @COURSEID= 7 , @TFNUMBER = 5 , @MCQNUMBER = 5

------ INSERT ANSWERS
EXEC SaveExamAnswers @ST_ID =203 ,@ExAM_ID =30 , @QUESTION_ID =1  , @STUDENT_ANSWER = 'd) DML (Maniplulation Language' --1)
EXEC SaveExamAnswers @ST_ID =203 ,@ExAM_ID =30 , @QUESTION_ID =7  , @STUDENT_ANSWER = 'b) links' --2)
EXEC SaveExamAnswers @ST_ID =203 ,@ExAM_ID =30 , @QUESTION_ID =11  , @STUDENT_ANSWER = 'a) red' --3)
EXEC SaveExamAnswers @ST_ID =203 ,@ExAM_ID =30 , @QUESTION_ID =12  , @STUDENT_ANSWER = 'a) Steve Jobs' --4)
EXEC SaveExamAnswers @ST_ID =203 ,@ExAM_ID =30 , @QUESTION_ID =17  , @STUDENT_ANSWER = 'd) export ' --5)
EXEC SaveExamAnswers @ST_ID =203 ,@ExAM_ID =30 , @QUESTION_ID =18  , @STUDENT_ANSWER = 'b) FALSE' --6)
EXEC SaveExamAnswers @ST_ID =203 ,@ExAM_ID =30 , @QUESTION_ID =19  , @STUDENT_ANSWER = 'b) FALSE' --7)
EXEC SaveExamAnswers @ST_ID =203 ,@ExAM_ID =30 , @QUESTION_ID =20  , @STUDENT_ANSWER = 'a) TRUE' --8)
EXEC SaveExamAnswers @ST_ID =203 ,@ExAM_ID =30 , @QUESTION_ID =21  , @STUDENT_ANSWER = 'a) TRUE' --9)
EXEC SaveExamAnswers @ST_ID =203 ,@ExAM_ID =30 , @QUESTION_ID =23  , @STUDENT_ANSWER = 'a) FALSE' --10)
---
-- CHECK THE STUDENT EXAM ANSWER TABLE 
SELECT * FROM Student_Exam
...
-- Test --
GO
EXEC ExamCorrection @st_id = 203 , @EXAM_ID = 30
-----
-- SHOW THE TABLE
SELECT * FROM Student_Exam
